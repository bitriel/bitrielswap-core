...
contract BitrielPool is IBitrielPool, NoDelegateCall {
    ...
    /// @inheritdoc IBitrielPoolImmutables
    ...
    /// @dev Prevents calling a function from anyone except the address returned by IBitrielFactory#owner()
    modifier onlyFactoryOwner() {
        require(msg.sender == IBitrielFactory(factory).owner());
        _;
    }
    ...
    constructor() {
        int24 _tickSpacing;
        (factory, token0, token1, fee, _tickSpacing) = IBitrielPoolDeployer(msg.sender).parameters();
    ...
    /// @inheritdoc IBitrielPoolDerivedState
    ...
    /// @inheritdoc IBitrielPoolActions
